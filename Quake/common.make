...
SHADER_OBJS = \
	...
	basic_emissive_alphatest_frag.o \
	basic_emissive_oit_frag.o \
	...
	world_emissive_bandlimit_volume_frag.o \
...
$(eval $(call SHADER_VARIANT,basic_emissive_alphatest_frag,basic.frag,-DEMISSIVE_ADD=1 -DALPHA_TEST=1))
$(eval $(call SHADER_VARIANT,basic_emissive_oit_frag,basic.frag,-DEMISSIVE_ADD=1 -DWBOIT=1))
...
$(eval $(call SHADER_VARIANT,world_emissive_bandlimit_volume_frag,world.frag,-DEMISSIVE_COARSE=1 -DEMISSIVE_DETAIL=1 -DEMISSIVE_BANDLIMIT=1 -DEMISSIVE_VOLUME=1))
...
$(eval $(call SHADER_VARIANT,world_liquid_emissive_frag,world.frag,-DEMISSIVE_ADD=1))
$(eval $(call SHADER_VARIANT,world_liquid_emissive_oit_frag,world.frag,-DEMISSIVE_ADD=1 -DWBOIT=1))
$(eval $(call SHADER_VARIANT,world_liquid_emissive_mboit_moment_frag,world.frag,-DEMISSIVE_ADD=1 -DMBOIT=1))
