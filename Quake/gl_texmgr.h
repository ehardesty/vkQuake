...
typedef struct gltexture_s
{
	...
	vec3_t				fullbright_color;		// normalized average linear color of a fullbright texture
	float				fullbright_coverage;	// average source-texel emissive coverage
	vec3_t				diffuse_color;			// average linear non-fullbright color for low-frequency lighting
